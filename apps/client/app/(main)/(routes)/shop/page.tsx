...
const ShopPage = () => {
  return (
    <div className="px-5 md:px-10 py-5 overflow-hidden">
      ...
      <h1 className="text-3xl font-bold mt-5 mb-20">Shop Now</h1>
      <div className="flex flex-wrap basis-auto justify-between gap-5 w-full">
        {productdata.map(
          (
            { img, title, price, url, gender, discount, avaibleColour, sizes },
            _id
          ) => (
